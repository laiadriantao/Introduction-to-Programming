...
Officer: 5871867
CaseNum: 801-0-88588677-5871867
...
- Do this by setting the identified  property of the element in audience to true. 
- We know that one member of the order is seated in the 10th row, 6th seat
...
function draw()
{
	...
	audience[9][5].identified = true;

	audience[7][3].identified = true;
	audience[7][4].identified = true;

	audience[6][0].identified = true;

	audience[5][0].identified = true;
	audience[5][7].identified = true;

	audience[4][8].identified = true;

	audience[1][6].identified = true;
