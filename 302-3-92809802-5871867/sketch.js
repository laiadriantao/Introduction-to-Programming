...
Officer: 5871867
CaseNum: 302-3-92809802-5871867
...
//move the first spotlight towards its end location
spotlight1.x += (spotlight1.endX - spotlight1.x) / 20;
spotlight1.y += (spotlight1.endY - spotlight1.y) / 20;

//move the second spotlight towards its end location
spotlight2.x += (spotlight2.endX - spotlight2.x) / 20;
spotlight2.y += (spotlight2.endY - spotlight2.y) / 20;

//move the third spotlight towards its end location
spotlight3.x += (spotlight3.endX - spotlight3.x) / 20;
spotlight3.y += (spotlight3.endY - spotlight3.y) / 20;
