...
Officer: 5871867
CaseNum: 801-1-98236530-5871867

Our person in the box office at the Console City opera house has just informed us that the influential Order of Swartz will be attending Don Giovanni tonight. This vain lot should be easy to spot thanks to their distinguished scarf. They are all sitting in the 6th seat of each row. 
...
function draw()
{
	image(crowdImg, 0, 0);
	////////////YOUR CODE GOES HERE////////////////////////
	for (var row = 0; row < viewers.length; row++) {
		// set the recognised property of the 6th viewer in the row to true
		viewers[row][5].recognised = true;
	}
